...
var (
	...
	fd_Supply_total_supply protoreflect.FieldDescriptor
)

func init() {
	file_qcore_pool_supply_proto_init()
	md_Supply = File_qcore_pool_supply_proto.Messages().ByName("Supply")
	fd_Supply_total_supply = md_Supply.Fields().ByName("total_supply")
}
...
func (x *Supply) slowProtoReflect() protoreflect.Message {
	mi := &file_qcore_pool_supply_proto_msgTypes[0]
...
func (x *fastReflection_Supply) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.TotalSupply != "" {
		...
		if !f(fd_Supply_total_supply, value) {
			return
		}
	}
}
...
func (x *fastReflection_Supply) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "qcore.pool.Supply.total_supply":
		return x.TotalSupply != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: qcore.pool.Supply"))
		}
		panic(fmt.Errorf("message qcore.pool.Supply does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Supply) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message qcore.pool.Supply does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Supply) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "qcore.pool.Supply.total_supply":
		panic(fmt.Errorf("field total_supply of message qcore.pool.Supply is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: qcore.pool.Supply"))
		}
...
func (x *fastReflection_Supply) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in qcore.pool.Supply", d.FullName()))
	}
	panic("unreachable")
}
...
func (*Supply) Descriptor() ([]byte, []int) {
	return file_qcore_pool_supply_proto_rawDescGZIP(), []int{0}
}

func (x *Supply) GetTotalSupply() string {
	if x != nil {
		return x.TotalSupply
	}
	return ""
...
var File_qcore_pool_supply_proto protoreflect.FileDescriptor

var file_qcore_pool_supply_proto_rawDesc = []byte{
	0x0a, 0x17, 0x71, 0x63, 0x6f, 0x72, 0x65, 0x2f, 0x70, 0x6f, 0x6f, 0x6c, 0x2f, 0x73, 0x75, 0x70,
	0x70, 0x6c, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0a, 0x71, 0x63, 0x6f, 0x72, 0x65,
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x2b, 0x0a, 0x06, 0x53, 0x75, 0x70, 0x70, 0x6c, 0x79, 0x12,
	0x21, 0x0a, 0x0c, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x5f, 0x73, 0x75, 0x70, 0x70, 0x6c, 0x79, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x53, 0x75, 0x70, 0x70,
	0x6c, 0x79, 0x42, 0x91, 0x01, 0x0a, 0x0e, 0x63, 0x6f, 0x6d, 0x2e, 0x71, 0x63, 0x6f, 0x72, 0x65,
	0x2e, 0x70, 0x6f, 0x6f, 0x6c, 0x42, 0x0b, 0x53, 0x75, 0x70, 0x70, 0x6c, 0x79, 0x50, 0x72, 0x6f,
...
var (
	file_qcore_pool_supply_proto_rawDescOnce sync.Once
	file_qcore_pool_supply_proto_rawDescData = file_qcore_pool_supply_proto_rawDesc
)

func file_qcore_pool_supply_proto_rawDescGZIP() []byte {
	file_qcore_pool_supply_proto_rawDescOnce.Do(func() {
		file_qcore_pool_supply_proto_rawDescData = protoimpl.X.CompressGZIP(file_qcore_pool_supply_proto_rawDescData)
	})
	return file_qcore_pool_supply_proto_rawDescData
}

var file_qcore_pool_supply_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_qcore_pool_supply_proto_goTypes = []interface{}{
	(*Supply)(nil), // 0: qcore.pool.Supply
}
var file_qcore_pool_supply_proto_depIdxs = []int32{
...
func init() { file_qcore_pool_supply_proto_init() }
func file_qcore_pool_supply_proto_init() {
	if File_qcore_pool_supply_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_qcore_pool_supply_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Supply); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_qcore_pool_supply_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_qcore_pool_supply_proto_goTypes,
		DependencyIndexes: file_qcore_pool_supply_proto_depIdxs,
		MessageInfos:      file_qcore_pool_supply_proto_msgTypes,
	}.Build()
	File_qcore_pool_supply_proto = out.File
	file_qcore_pool_supply_proto_rawDesc = nil
	file_qcore_pool_supply_proto_goTypes = nil
	file_qcore_pool_supply_proto_depIdxs = nil
}
